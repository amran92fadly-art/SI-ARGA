...
// 2. Fungsi untuk Menampilkan Data di Tabel Berdasarkan Tahun (Lengkap dengan Tombol Aksi)
                ...
                if (tahun === 'SEMUA' || item.tahunArsip == tahun) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm mb-1" onclick="editArsipOnline('${item.namaDokumen}')">
                            ✏️ Edit
                            </button>
                            <button class="btn btn-danger btn-sm mb-1" onclick="hapusArsipOnline('${item.namaDokumen}')">
                            🗑️ Hapus
                            </button>
                        </td>
                    </tr>
